...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String email=preferences.getString(MainActivity.EMAIL,"");
        ...
        if(intent.hasExtra(SignUpActivity.EMAIL)){
            mEmailView.setText(intent.getExtras().getString(SignUpActivity.EMAIL,""));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                String userInfo=wc.checkUser(mEmail,mPassword);

                if(userInfo.contains("fail")) {
                    Toast.makeText(getApplication(),"Invalid user or password",Toast.LENGTH_SHORT).show();
                    return false;
                }
        ...
        protected void saveToSharedPrefrences(String data){
            ...
            String contactno=st.nextToken().trim();
            String gender=st.nextToken().trim();

            SharedPreferences preferences= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
            SharedPreferences.Editor editor=preferences.edit();
            editor.putString(MainActivity.RATID,ratid);
            ...
            editor.putString(MainActivity.DATEOFBIRTH,dateofbirth);
            editor.putString(MainActivity.CONTACTNO,contactno);
            editor.putString(MainActivity.GENDER,gender);
            editor.putString(MainActivity.DATEINMILLIS,dateinmillis);
            editor.commit();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPasswordView.setError("Email/password incorrect");
